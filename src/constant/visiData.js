...
export const VISION_KR = [
  {
    title: "비전",
    description:
      "우리의 목표는 동남아시아 전역의 브랜드를 위한 다리이자 마케팅 강국이 되어, 자원, 네트워크 및 깊은 시장 이해를 통해 원활하게 확장하고 판매할 수 있도록 하는 것입니다. 인도네시아에서 말레이시아, 싱가포르, 베트남, 태국, 한국, 중국 등으로 이어지는 이 지역을 연결하여 브랜드가 국경 없이 확장할 수 있도록 합니다.",
    bulletPoints: [],
  },
  {
    title: "미션",
    description:
      "우리는 이중 핵심 비즈니스 모델을 통해 브랜드의 성공을 촉진합니다:",
    bulletPoints: [
      "유통 파워하우스 - 모든 물류 및 규정 준수 처리",
      "마케팅 가속기 - 수요 창출 및 판매 촉진",
    ],
  },
];
